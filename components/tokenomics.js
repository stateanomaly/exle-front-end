            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="wow fadeInUp mb-9" data-wow-delay="0s">
                ...
                <p className="text-lg font-medium text-body-color-2 dark:text-body-color">
                  Ergopad has the honor of facilitating the IDO of EXLE. EXLE
                  will be a person-to-person (P2P) lending platform with easy to
                  use tools to borrow and lend money.
                </p>
              </div>
