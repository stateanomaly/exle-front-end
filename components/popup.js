    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          ...
          >
            <b className={classes.copyText}>
              {' '}
              {props.address.length > 40
                ? `${props.address.substring(
                    0,
                    20
                  )}...${props.address.substring(props.address.length - 20)}`
                : props.address}
            </b>
          </CopyToClipboard>
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          Your funds will be sent back to you in case of any failure. Smart
          contracts are being used to prevent the intermediate service from
          cheating!
        </DialogContentText>
      </DialogContent>
    </Dialog>
